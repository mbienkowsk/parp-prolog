...
describe(generator_room) :-
    ...
    write('glimpse into the halted functionality of the lab\'s power source. The ventilation shaft on the southern wall,'), nl,
    write('though vibrating with a faint breeze, seems large enough for someone to'), nl,
    write('fit through.'),
    nl.
